...
#define vibrationSensorMiddle A0
#define x A1
#define y A2
#define z A3
...
{
  pinMode(4,OUTPUT);
  pinMode(vibrationSensorMiddle, INPUT);
  Serial1.begin(9600);
  Serial.begin(9600);
//  lcd.begin(16,2);  
...
//    long vibrationSensorValueMiddle = pulseIn (vibrationSensorMiddle, HIGH);
//    vibrationSensorValueTotal = vibrationSensorValueMiddle;
//    Serial.println(vibrationSensorValueTotal);
// 
    Serial.println("ACCIDENT DETECTED");
      get_gps();
      show_coordinate();
//      Serial.println("Press the red button to cancel the SMS SOS service");
//     for(int i=0;i<10;i++)
//    {
//         delay(1000);
...
void Send()
{
   ...
   Serial1.print('"');
   Serial1.print("6283782181");    //mobile no. for SMS alert
   Serial1.println('"');
   delay(500);
   serialPrint();
   ...
   Serial2.println("AT+CGATI?");
    Serial.println("AT+CGATI?");
    Serial.println("OK");
   delay(100);
   while(Serial2.available())
   {
   ...
   Serial2.println("AT+SAPBR=3,1,\"APN\",\"3gprs\"");
   ...
   Serial2.print("AT+HTTPPARA=\"URL\",\"localhost/hackathon/php3.php?latitude=");
   Serial2.print(latitude);
   Serial2.print("&longitude=");
   Serial2.print(logitude);
   //Serial1.print(
   delay(100);
   Serial.print("AT+HTTPPARA=\"URL\",\"localhost/hackathon/php3.php?latitude=");
   Serial.print(latitude);
   Serial.print("&longitude=");
